...
public class OOClient {
    ...
    /* connect to the server, then repeatedly:
        ...
        The amount and format of the console output
        (e.g., user prompt, server replies) are imposed as part of
        the problem statement in the handout.
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                if (reply.equalsIgnoreCase("Invalid Option!")) {
                    reply = in.readUTF();
                    System.out.println(reply);
                }
    ...
    /* open the necessary I/O streams and initialize the in, out, and
     console static variables; this method does not catch any
     exceptions.
     */
